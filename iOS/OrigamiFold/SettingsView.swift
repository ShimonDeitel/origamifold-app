...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("About") {
                Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/origamifold-app/privacy.html")!)
                Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/origamifold-app/terms.html")!)
                Text("Version 1.0")
